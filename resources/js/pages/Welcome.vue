    ...
    <div
        ...
        <div
            ...
            <main
                ...
                >
                    <h1 class="mb-1 font-medium">Sua Carteira Digital. Seu dinheiro, suas regras.</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Transfira, deposite e gerencie seu dinheiro com segurança
                    </p>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Envie e receba dinheiro em tempo real, para qualquer usuário
                            </span>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <span>
                                Acompanhe todas suas transações e gerencie seu dinheiro
                            </span>
                        </li>
                    </ul>
